...
def run_sdrf_node_classification(data, model_type, num_features, num_classes, hidden_dimension, dropout, lr, weight_decay,
                       device, sdrf_max_iter_ratio, sdrf_tau, sdrf_removal_bound, cluster_size, init_seeds=1):
    ...
    new_data, new_edge_weight = SDRF_rewiring(data, cluster_size, sdrf_max_iter_ratio, sdrf_tau, sdrf_removal_bound)
...
def main():
    ...
    run_sdrf_node_classification(data, args.model, num_features, num_classes, args.hidden_dimension, args.dropout, args.lr,
                       args.weight_decay, args.device, args.sdrf_max_iter_ratio, args.sdrf_tau, args.sdrf_removal_bound,
                       args.cluster_size)
